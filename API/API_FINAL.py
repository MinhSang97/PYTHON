...
def is_valid_login(user_name, password):
    ...
    if user_name == 'admin' and password == 'hhm@1997':
        return True
    elif user_name == 'HTXNNLH' and password == 'qa52sw':
        return True
    #minhcham(HTXDVLH)
    elif user_name == 'HTXDVLH' and password == '123456': 
        return True
    elif user_name == 'NINHHIEP' and password == 'mkjnhb':
        return True
    elif user_name == 'TAYDANG' and password == 'a4s5d6':
        return True
    elif user_name == 'HTXTH' and password == 'lpokij':
        return True
    elif user_name == 'LIENHADANPHUONG' and password == 'h4j5k6':
        return True
    return False
