...
image_path = "image/"
weight_path_cos = "300.pth"
weight_path_realfake = "005.pth"
...
model.load_state_dict(torch.load(weight_path_realfake, map_location=torch.device('cpu')))
...
# json_file.close()
# # Create antispoofing model from json archie
...
net.load_state_dict(torch.load(weight_path_cos, map_location=torch.device('cpu')))
net.eval()
