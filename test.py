...
if selected_port is not None:
    ...
    if ser is not None:
        ...
        layout = [
            ...
            [sg.Output(size=(60, 10), key="-OUTPUT-")]  # Vùng hiển thị dữ liệu phản hồi
        ]
        
        window = sg.Window("Gửi lệnh tới cổng COM", layout)
        
        # Danh sách lưu trữ log
        log = []
        ...
        while True:
            ...
            if event == "-SEND-":
                ...
                output_elem.update(value="\n".join(f"Lệnh: {cmd}, Phản hồi: {resp}" for cmd, resp in log))
